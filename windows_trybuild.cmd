...
node %GITHUB_WORKSPACE%\CRLF2LF.js %GITHUB_WORKSPACE%\win_build_v%VERSION%.patch
call git apply --cached --reject %GITHUB_WORKSPACE%\win_build_v%VERSION%.patch
node %GITHUB_WORKSPACE%\CRLF2LF.js %GITHUB_WORKSPACE%\lib_uv_add_on_watcher_queue_updated_v%VERSION%.patch
call git apply --cached --reject %GITHUB_WORKSPACE%\lib_uv_add_on_watcher_queue_updated_v%VERSION%.patch
call git checkout -- .
